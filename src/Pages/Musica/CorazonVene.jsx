            ...
            <div className="seccion row">
                ...
                <div className="col-lg-8">
                    <div className="accordion" id="accordionExample">
                        ...
                        <Cancion
                            num={23}
                            titulo="Corazon Venezolano"
                            letra={`Yo tengo un corazón de alpargatas
                        ...
                        <Cancion
                            num={25}
                            titulo="Déjame ser tuyo"
                            letra={`Dime que tienes en tu boquita 
                        ...
                        <Cancion
                            num={26}
                            titulo="Si no consigo olvidarla"
                            letra={`Yo no sé que va a pasar
                        ...
                        <Cancion
                            num={30}
                            titulo="La vida es un pan con leche"
                            letra={`Cuando Dios creaba al hombre
                        ...
                        <Cancion
                            num={32}
                            titulo="Y cuenta que cuenta cuentos"
                            letra={`Ya le canté los pollitos
                                Le hable del gato
                                De la lora
                                Y del abuelo
                        ...
                        <Cancion
                            num={33}
                            titulo="El fragil sueño de la vida"
                            letra={`Mueve
                                El viento la rama
                                Dónde esta el nido
                                Donde esta el ave
